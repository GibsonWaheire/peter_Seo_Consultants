      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 policy-content">
          ...
          <div className="hidden page-header-print">
            <h1 className="text-2xl font-bold">Iknus Consultants — Refund Policy</h1>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-6 mb-6 text-sm leading-relaxed">
            This Refund Policy ("Policy") governs all transactions made with Iknus Consultants
            ("Company", "we", "us", "our"). By completing a payment for any service offered by
            Iknus Consultants, the client ("you", "your") acknowledges and unconditionally
          ...
          <div className="space-y-4">
            ...
            <Section title="1. Refund Method and Payment Channel">
              <p>
                ...
                and instrument used to originate the transaction. Iknus Consultants shall not,
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  ...
                  transactions and 1–3 business days for M-Pesa. Iknus Consultants has no control
                ...
                <li>
                  ...
                  the time of the original transaction. Iknus Consultants shall not be liable for
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 text-amber-800 text-xs">
                ...
                details entered at checkout are accurate and current. Iknus Consultants shall not
            ...
            <Section title="2. SEO Monthly Retainers">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  ...
                  SEO results depend on search engine algorithms beyond our control. Iknus Consultants
            ...
            <Section title="4. Website Development">
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li>
                  <strong className="text-slate-800">Cancellation by Iknus Consultants:</strong>{' '}
                  In the event that Iknus Consultants is unable to proceed, a full refund of all
            ...
            <Section title="5. Refund Request Procedure">
              <p>
                To initiate a refund request, the client must contact Iknus Consultants within
                ...
                Iknus Consultants shall acknowledge the request within one (1) business day and,
            ...
            <Section title="6. Disputes and Governing Law">
              <p>
                ...
                to Iknus Consultants for informal resolution. If unresolved within 14 days, the
                ...
                agree that Kenyan law governs all transactions and disputes with Iknus Consultants.
              </p>
            </Section>
