      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 policy-content">
          ...
          <div className="hidden page-header-print">
            <h1 className="text-2xl font-bold">Peter SEO Consultants — Privacy Notice</h1>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-6 mb-6 text-sm leading-relaxed">
            This Privacy Notice ("Notice") explains how Peter SEO Consultants ("Company", "we",
          ...
          <div className="space-y-4">
            ...
            <Section title="1. Data Controller">
              <p>
                The data controller responsible for your personal information is Peter SEO Consultants,
            ...
            <Section title="7. Security">
              <p>
                Peter SEO Consultants implements reasonable technical and organisational measures to
            ...
            <Section title="8. Your Rights">
              <p>
                ...
                to your personal data held by Peter SEO Consultants:
              </p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="9. Changes to This Notice">
              <p>
                Peter SEO Consultants reserves the right to amend this Privacy Notice at any time.
