      ...
      <section className="py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 policy-content">
          ...
          <div className="hidden page-header-print">
            <h1 className="text-2xl font-bold">Peter SEO Consultants — Terms &amp; Conditions</h1>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-6 mb-6 text-sm leading-relaxed">
            ...
            you ("Client", "you", "your") and Peter SEO Consultants ("Company", "we", "us", "our"),
            ...
            with Peter SEO Consultants, you unconditionally accept and agree to be bound by the
          ...
          <div className="space-y-4">
            ...
            <Section title="1. Parties and Agreement">
              <p>
                This Agreement is entered into between Peter SEO Consultants (Nairobi, Kenya)
                and the Client. It governs all services procured through our website, via WhatsApp,
                or through any other channel through which Peter SEO Consultants receives a service
                request or payment.
              </p>
              <p>
            ...
            <Section title="2. Scope of Services">
              <p>
                Peter SEO Consultants provides the following categories of services, the full details
            ...
            <Section title="3. Payment Obligations">
              <p>
                ...
                unless a separate written arrangement has been agreed. Peter SEO Consultants shall
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  ...
                  calculated using the live exchange rate at the time of transaction. Peter SEO Consultants
            ...
            <Section title="4. Refunds">
              <p>
                All refunds are governed by Peter SEO Consultants'{' '}
                ...
                via the same payment channel used for the original transaction. Peter SEO Consultants shall
                ...
                card issuer or bank are non-reimbursable by Peter SEO Consultants.
              </p>
            </Section>
            ...
            <Section title="5. Turnaround Times and Delays">
              <p>
                ...
                guaranteed delivery dates. Peter SEO Consultants shall not be held in breach of this
              ...
              <p>
                Peter SEO Consultants shall notify the Client of any material delay and shall take
                reasonable steps to complete the service as soon as practicable.
              </p>
            </Section>

            <Section title="6. Client Obligations">
              <p>By engaging Peter SEO Consultants, the Client agrees to:</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Provide accurate, complete, and truthful information required for service delivery</li>
                <li>Respond to queries from Peter SEO Consultants within a reasonable time to avoid project delays</li>
                <li>Grant necessary access to website, analytics, and ad accounts required to perform the agreed service</li>
                <li>Use Peter SEO Consultants' services solely for lawful purposes and in compliance with all applicable laws of Kenya</li>
              </ul>
              <p>
                Peter SEO Consultants reserves the right to suspend or terminate service delivery
            ...
            <Section title="7. Intellectual Property">
              <p>
                ...
                and strategy documents) are assigned to the Client. Peter SEO Consultants retains no
            ...
            <Section title="8. Limitation of Liability">
              <p>
                To the maximum extent permitted by applicable law, Peter SEO Consultants' total
              ...
              <p>
                Peter SEO Consultants shall not be liable for any indirect, consequential, special,
                ...
                or otherwise, even if Peter SEO Consultants has been advised of the possibility of
                such damages.
              </p>
              <p>
                Peter SEO Consultants expressly excludes liability for ranking fluctuations caused
            ...
            <Section title="10. Governing Law and Dispute Resolution">
              <p>
                ...
                shall first be referred to Peter SEO Consultants for informal resolution. If not resolved
              ...
              <p>
                ...
                all transactions and disputes with Peter SEO Consultants, and waive any objection to
            ...
            <Section title="11. Amendments">
              <p>
                Peter SEO Consultants reserves the right to amend this Agreement at any time. The
            ...
            <Section title="12. Contact">
              <p>
                For any questions, disputes, or notices under this Agreement, contact Peter SEO Consultants at:
              </p>
